...
//                    System.out.println(playlist.getName() + " " + playlistName);
////                    System.out.println(song.getArtist());
////                    playlist.removeSong(DB.getArtists().get(song.getArtist()).getSong(song.getId()));
////                    playlist.removeSongById(song.getId());
//                    playlist.removeSongById("0019");
...
//                if (playlist.getName().equals(p.getName())) {
//                    p = playlist;
//                }
//            }
            try {
